...
public final class AudiosImpl {
    ...
    public interface AudiosService {
        ...
        Response<BinaryData> createSpeechSync(@HeaderParam("accept") String accept,
            @BodyParam("application/json") BinaryData speech, RequestOptions requestOptions);
        ...
        @UnexpectedResponseExceptionDetail(exceptionTypeName = "RESOURCE_MODIFIED", statusCode = { 409 })
        @UnexpectedResponseExceptionDetail
        Response<CreateTranscriptionResponseVerboseJson> createTranscriptionSync(
            @HeaderParam("content-type") String contentType, @HeaderParam("accept") String accept,
            @BodyParam("multipart/form-data") BinaryData audio, RequestOptions requestOptions);
        ...
        @UnexpectedResponseExceptionDetail(exceptionTypeName = "RESOURCE_MODIFIED", statusCode = { 409 })
        @UnexpectedResponseExceptionDetail
        Response<CreateTranslationResponseVerboseJson> createTranslationSync(
            @HeaderParam("content-type") String contentType, @HeaderParam("accept") String accept,
            @BodyParam("multipart/form-data") BinaryData audio, RequestOptions requestOptions);
    }
    ...
    public Response<BinaryData> createSpeechWithResponse(BinaryData speech, RequestOptions requestOptions) {
        ...
        return service.createSpeechSync(accept, speech, requestOptions);
    }
     ...
     */
    public Response<CreateTranscriptionResponseVerboseJson> createTranscriptionWithResponse(BinaryData audio,
        RequestOptions requestOptions) {
        final String contentType = "multipart/form-data";
        final String accept = "application/json, text/plain";
        return service.createTranscriptionSync(contentType, accept, audio, requestOptions);
    }
     ...
     * @return the response.
     */
    public Response<CreateTranslationResponseVerboseJson> createTranslationWithResponse(BinaryData audio,
        RequestOptions requestOptions) {
        final String contentType = "multipart/form-data";
        final String accept = "application/json, text/plain";
        return service.createTranslationSync(contentType, accept, audio, requestOptions);
    }
}
