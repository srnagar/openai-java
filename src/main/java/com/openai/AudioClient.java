...
public final class AudioClient {
     ...
     */
    @Metadata(generated = true)
    Response<CreateTranscriptionResponseVerboseJson> createTranscriptionWithResponse(BinaryData audio,
     ...
     */
    @Metadata(generated = true)
    Response<CreateTranslationResponseVerboseJson> createTranslationWithResponse(BinaryData audio,
        RequestOptions requestOptions) {
