...
public final class ImagesClient {
     ...
     */
    @Metadata(generated = true)
    Response<ImagesResponse> createImageEditWithResponse(BinaryData image, RequestOptions requestOptions) {
     ...
     */
    @Metadata(generated = true)
    Response<ImagesResponse> createImageVariationWithResponse(BinaryData image, RequestOptions requestOptions) {
